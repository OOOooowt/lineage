...
public class HiveBloodEngineTest extends BaseTest{
	...
	public void testGetTableBlood() throws Exception{
		TableBlood tableBlood = bloodEngine.getTableBlood(Arrays.asList(hqls6));
	...
	public void testGetTableFields() throws Exception{
		List<HiveField> fields = bloodEngine.getTableFields(Arrays.asList(MyConstant.hql1), new HiveTable("t", "target"));
...
//		System.in.read();
	...
	public void testGetFieldBloodByTable() throws Exception{
		FieldBlood fieldBlood = bloodEngine.getFieldBloodByTable(Arrays.asList(MyConstant.hql1), new HiveTable("t", "target"));
